...
HD_PWD='C:/Users/Jan/Dropbox/Uni/valencia/practicas/FPGA/CCRYSP_pileup/testbench_prototyping/testbench_prototyping.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dummy.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dummy.tcl
