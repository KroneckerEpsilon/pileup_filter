...
#
# Script generated by Vivado on Tue Oct 01 18:51:22 +0200 2024
...
# script info
echo -e "div_gen_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/Jan/Dropbox/Uni/valencia/practicas/FPGA/CCRYSP_pileup/testbench_prototyping/testbench_prototyping.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
